...
public class Stage_T_3_2 : Stage
{
    //Private Variables
    ...
    //Public Variables
    public Stage_T_4_1 stage_T_4_1;
    ...
    public override Stage RunCurrentStage()
    {
        ...
        if (_advancementBool)
        {
            Debug.Log("Stage_T_3_2 completed! Next Stage: " + stage_T_4_1);
            return stage_T_4_1;
        }
        else
        {
    ...
    public void ToggleStageAdvancingFlag()
    {
        if (_conditionMet == false)
        {
            ...
            AudioManager.Instance.ShootAudioEvent_Owl_VL_T_4_1();
