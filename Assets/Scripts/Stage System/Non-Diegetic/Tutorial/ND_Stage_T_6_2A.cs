...
public class ND_Stage_T_6_2A : Stage
{
    //Private Variables
    ...
    //Public Variables
    public ND_Stage_T_6_2B ND_stage_T_6_2B;
    ...
    public override Stage RunCurrentStage()
    {
        ...
        if (_advancementBool)
        {
            ...
            Debug.Log("Stage_T_6_2A completed! Next Stage: " + ND_stage_T_6_2B);
            return ND_stage_T_6_2B;
        }
        else
        {
            return this;
