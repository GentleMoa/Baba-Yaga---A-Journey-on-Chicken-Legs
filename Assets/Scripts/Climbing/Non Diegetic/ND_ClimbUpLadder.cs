...
public class ND_ClimbUpLadder : MonoBehaviour
{
    ...
    [SerializeField] private ND_Stage_T_5_2 ND_stage_T_5_2;
    [SerializeField] private ND_Stage_1_6 ND_stage_1_6;
    [SerializeField] private ND_Stage_3_3 ND_stage_3_3;
    ...
    private void NestedClimbUpFunction_4()
    {
        ...
        if (StageManager.Instance.currentStage == ND_stage_T_5_2)
        {
            ND_stage_T_5_2.ToggleStageAdvancingFlag();
        } 
        else if (StageManager.Instance.currentStage == ND_stage_1_6)
        {
            ND_stage_1_6.ToggleStageAdvancingFlag();
        }
        else if (StageManager.Instance.currentStage == ND_stage_3_3)
        {
            ND_stage_3_3.ToggleStageAdvancingFlag();
        }
        else
        {
            //Do nothing
