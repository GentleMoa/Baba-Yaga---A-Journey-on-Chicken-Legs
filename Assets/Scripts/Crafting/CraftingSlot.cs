...
public class CraftingSlot : MonoBehaviour
{
    ...
    [SerializeField] private CraftingRecipes craftingRecipeScript;
    ...
    private void Start()
    {
        ...
        craftingRecipeScript.DestroyCraftingIngredients += ClearAndDestroyIngredient;
        craftingRecipeScript.RefreshSocketInteractors += ResetSocketInteractor;
    }
